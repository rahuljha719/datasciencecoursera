...
activity_labels<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\activity_labels.txt")

#add more descriptive names to activity labels columns
names(activity_labels)<-c("Activity.Id","Activity")

# 1.2 read in feture list
feature_list<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\features.txt")
...
test_subjects<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\test\\subject_test.txt")
...
test_dataset<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\test\\X_test.txt")
...
test_activities<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\test\\Y_test.txt")
...
train_subjects<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\train\\subject_train.txt")
...
train_dataset<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\train\\X_train.txt")
...
train_activities<-read.table("E:\\directory\\getdata_projectfiles_UCI HAR Dataset\\UCI HAR Dataset\\train\\Y_train.txt")
